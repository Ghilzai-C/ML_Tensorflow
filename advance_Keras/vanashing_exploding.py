...
X_train, X_valid, Y_train, Y_valid = train_test_split(X_train_full[:-20000], 
                                                      y_train_full[:-20000], random_state = 42)
...
# # 
# eLU = tf.keras.layers.Dense(50, activation="elu",
#                             kernel_initializer="he_normal")
# seLU = tf.keras.layers.Dense(50, activation="selu", kernel_initializer="lecun_normal")
